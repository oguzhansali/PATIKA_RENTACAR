...
public class BookingView  extends Layout{
    ...
    public BookingView(Car selectedCar,String strt_date,String fnsh_date){
        ...
        //Test için
        this.fld_book_name.setText("Oğuzhan SALİ");
        this.fld_book_idno.setText("12344231312");
        this.fld_book_mail.setText("oguz@gmail.com");
        this.fld_book_mpno.setText("056926623265");
